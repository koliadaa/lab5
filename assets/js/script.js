...
const Slider = {
  ...
  initSlider: function (slides) {
    ...
    for (let slide of slides) {
      this.slides.push(
        new Slide(index, slide.title, slide.background, slide.link)
      );
      index++;
    }
    this.buildSlider();
  ...
  prevSlide: function () {
    ...
    document
      .getElementById("slide-" + this.current)
...
const leftControl = document.querySelector(".slider-left");
const rightControl = document.querySelector(".slider-right");
...
const hideControl = document.querySelector(".slider-toggle");
...
const slideShowBtn = document.querySelector(".slide-show");
